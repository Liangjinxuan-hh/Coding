...
|---|---:|---:|---:|---:|---:|
| control_status | 50 | 100.00% | 13.624 | 28.075 | 30.557 |
| health | 50 | 100.00% | 16.697 | 29.496 | 68.376 |
| ingest_event | 100 | 100.00% | 14.865 | 29.869 | 32.343 |
| voice_plan | 30 | 100.00% | 11.938 | 27.821 | 29.030 |
| event_to_ws（中继） | 30 | 100.00% | 0.258 | 0.370 | 0.426 |
...
- 事件注入到 WebSocket 广播的中继时延非常低（P95 = 0.370ms），满足实时交互需求。
- `health` 与 `voice_plan` 存在个别高值（最大 68.376ms / 29.030ms），整体波动可接受。
